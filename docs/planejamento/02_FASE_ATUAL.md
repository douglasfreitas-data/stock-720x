...
- [x] **F3.1.3** Recuperar funcionalidade de **Estoque Mínimo** no inventário (Nuvemshop não exporta nativamente, requer criar coluna `min_stock` na tabela local `product_variants` do Supabase e adaptar o frontend).
