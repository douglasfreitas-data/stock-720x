...
export default function PrintQRScreen({ products, onClose }) {
    ...
    const generatePDF = async () => {
        ...
        try {
            ...
            const margin = 15
            const itemHeight = 50 // Height for each product row
            ...
            for (let i = 0; i < products.length; i++) {
                ...
                // Category & Brand
                pdf.setFontSize(9)
                pdf.text(`${product.category} | ${product.brand}`, textX, y + 27)
